package com.teqanta.ggpgs.signal
...
fun getSignals(): MutableSet<SignalInfo> = mutableSetOf(
    ...
    SignInSignals.userDetailsSignals,
...
object SignInSignals {
    ...
    val userDetailsSignals = SignalInfo("userDetailsSignal", String::class.java)
...
object AchievementsSignals {
    /**
     * This signal is emitted when calling the [com.teqanta.plugin.android.godotplaygameservices.GodotAndroidPlugin.incrementAchievement]
     * or [com.teqanta.plugin.android.godotplaygameservices.GodotAndroidPlugin.unlockAchievement] methods.
     *
    ...
    /**
     * This signal is emitted when calling the [com.teqanta.plugin.android.godotplaygameservices.GodotAndroidPlugin.loadAchievements] method.
     *
    ...
    /**
     * This signal is emitted when calling the [com.teqanta.plugin.android.godotplaygameservices.GodotAndroidPlugin.revealAchievement] method.
     *
...
object LeaderboardSignals {
    /**
     * This signal is emitted when calling the [com.teqanta.plugin.android.godotplaygameservices.GodotAndroidPlugin.submitScore] method.
     *
    ...
    /**
     * This signal is emitted when calling the [com.teqanta.plugin.android.godotplaygameservices.GodotAndroidPlugin.loadPlayerScore] method.
     *
    ...
    /**
     * This signal is emitted when calling the [com.teqanta.plugin.android.godotplaygameservices.GodotAndroidPlugin.loadPlayerCenteredScores] method.
     *
    ...
    /**
     * This signal is emitted when calling the [com.teqanta.plugin.android.godotplaygameservices.GodotAndroidPlugin.loadTopScores] method.
     *
     * @return The leaderboard id and a JSON with a [com.google.android.gms.games.LeaderboardsClient.LeaderboardScores](https://developers.google.com/android/reference/com/google/android/gms/games/LeaderboardsClient.LeaderboardScores).
     */
    ...
    /**
     * This signal is emitted when calling the [com.teqanta.plugin.android.godotplaygameservices.GodotAndroidPlugin.loadAllLeaderboards] method.
     *
    ...
    /**
     * This signal is emitted when calling the [com.teqanta.plugin.android.godotplaygameservices.GodotAndroidPlugin.loadLeaderboard] method.
     *
...
object PlayerSignals {
    /**
     * This signal is emitted when calling the [com.teqanta.plugin.android.godotplaygameservices.GodotAndroidPlugin.loadFriends] method.
     *
     ...
     * calling the [com.teqanta.plugin.android.godotplaygameservices.GodotAndroidPlugin.searchPlayer] method.
     *
    ...
    /**
     * This signal is emitted when calling the [com.teqanta.plugin.android.godotplaygameservices.GodotAndroidPlugin.loadCurrentPlayer] method.
     *
     * @return A JSON with a [com.google.android.gms.games.Player](https://developers.google.com/android/reference/com/google/android/gms/games/Player).
     */
...
object SnapshotSignals {
    /**
     * This signal is emitted when calling the [com.teqanta.plugin.android.godotplaygameservices.GodotAndroidPlugin.saveGame] method.
     *
    ...
    /**
     * This signal is emitted when calling the [com.teqanta.plugin.android.godotplaygameservices.GodotAndroidPlugin.loadGame] method
     * or after selecting a saved game in the window opened by the [com.teqanta.plugin.android.godotplaygameservices.GodotAndroidPlugin.showSavedGames] method.
     *
    ...
    /**
     * This signal is emitted when calling the [com.teqanta.plugin.android.godotplaygameservices.GodotAndroidPlugin.loadSnapshots] method.
     *
...
object EventsSignals {
    /**
     * This signal is emitted when calling the [com.teqanta.plugin.android.godotplaygameservices.GodotAndroidPlugin.loadEvents] method.
     *
    ...
    /**
     * This signal is emitted when calling the [com.teqanta.plugin.android.godotplaygameservices.GodotAndroidPlugin.loadEventsByIds] method.
     *
     * @return A JSON with the list of [com.google.android.gms.games.event.Event](https://developers.google.com/android/reference/com/google/android/gms/games/event/Event).
     */
